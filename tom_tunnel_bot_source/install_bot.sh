...
# wget -q -O /root/doty_bot/main.py https://raw.githubusercontent.com/TON_USER/TON_REPO/main/tom_tunnel_bot_source/main.py
# wget -q -O /root/doty_bot/core/xray_handler.py https://raw.githubusercontent.com/TON_USER/TON_REPO/main/tom_tunnel_bot_source/core/xray_handler.py
# wget -q -O /root/doty_bot/core/ssh_handler.py https://raw.githubusercontent.com/TON_USER/TON_REPO/main/tom_tunnel_bot_source/core/ssh_handler.py
# wget -q -O /root/doty_bot/utils/qr_generator.py https://raw.githubusercontent.com/TON_USER/TON_REPO/main/tom_tunnel_bot_source/utils/qr_generator.py
