...
TOM_TUNNEL_WEB_DIR="/opt/tom_tunnel-vpn-web"
CONFIG_DIR="/etc/tom_tunnel-vpn-web"
...
function tom_tunnel_web_menu() {
  [ -f "$UI" ] && k_header "TOM_TUNNEL • WEB" || clear
  local status_str
  ...
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}           TOM_TUNNEL TUNNEL WEB — MENU 18           ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
...
function ntw_install() {
  clear
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}         INSTALLATION — TOM_TUNNEL TUNNEL WEB         ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo ""
  echo -e "  Ce script va installer l'interface web TOM_TUNNEL Tunnel."
  ...
  elif [ -f /opt/tom_tunnel-vpn-web/install.sh ]; then
    bash /opt/tom_tunnel-vpn-web/install.sh
  else
    echo -e "${RD}  [ERROR] Source install script not found.${NC}"
    echo -e "  Expected one of:"
    echo -e "    - /usr/local/sbin/tom_tunnel-web/install.sh"
    echo -e "    - /opt/tom_tunnel-vpn-web/install.sh"
...
function ntw_update() {
  clear
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}          MISE À JOUR TOM_TUNNEL TUNNEL WEB           ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo ""
  ...
  sed -i "s|const PUBLIC_DIR = .*|const PUBLIC_DIR = '/opt/tom_tunnel-vpn-web/public';|g" \
...
function ntw_uninstall() {
  clear
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}          DÉSINSTALLER TOM_TUNNEL TUNNEL WEB          ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo ""
