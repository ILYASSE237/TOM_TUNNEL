...
clear
# ====== STYLE REFONDU : EN-TÊTE SYSTÈME ======
printf '%b\n' "${K_CYAN}╔════════════════════════════════════════════════════════════════╗${K_RESET}"
printf '%b\n' "${K_CYAN}║${K_RESET}                ${K_WHITE}🚀 TOM_TUNNEL SYSTEM INFO${K_RESET}                 ${K_CYAN}║${K_RESET}"
printf '%b\n' "${K_CYAN}╠════════════════════════════════════════════════════════════════╣${K_RESET}"
printf '%b\n' "${K_CYAN}║${K_RESET}  🖥️  OS      : ${K_GREEN}$(printf '%-35s' "${OS:0:35}")${K_RESET}${K_CYAN}║${K_RESET}"
printf '%b\n' "${K_CYAN}║${K_RESET}  🌐 IPv4    : ${K_GREEN}$(printf '%-35s' "${MYIP:-N/A}")${K_RESET}${K_CYAN}║${K_RESET}"
printf '%b\n' "${K_CYAN}║${K_RESET}  🌍 IPv6    : ${K_GREEN}$(printf '%-35s' "${IPV6:-N/A}")${K_RESET}${K_CYAN}║${K_RESET}"
printf '%b\n' "${K_CYAN}║${K_RESET}  🔗 DOMAIN  : ${K_GREEN}$(printf '%-35s' "${domain:0:35}")${K_RESET}${K_CYAN}║${K_RESET}"
printf '%b\n' "${K_CYAN}║${K_RESET}  ⏱️  UPTIME  : ${K_GREEN}$(printf '%-35s' "${uptime:0:35}")${K_RESET}${K_CYAN}║${K_RESET}"
printf '%b\n' "${K_CYAN}╚════════════════════════════════════════════════════════════════╝${K_RESET}"
echo

# ====== SECTION PROTOCOLES TOM_TUNNEL (MODIFIÉ ICI) ======
printf '%b\n' "${K_YELLOW}╔════════════════════════════════════════════════════════════════╗${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}           ${K_WHITE}🚀 PROTOCOLES TOM_TUNNEL${K_RESET}                        ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}╠════════════════════════════════════════════════════════════════╣${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[01]${K_RESET} 🔑 SSH/WS          $(mark dropbear 2>/dev/null || mark ssh)              ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[02]${K_RESET} ⚡ VMESS           $(mark xray)              ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[03]${K_RESET} 🚀 VLESS           $(mark xray)              ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[04]${K_RESET} 🛡️  TROJAN          $(mark xray)              ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[05]${K_RESET} 🌐 SOCKS           $(mark xray)              ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[06]${K_RESET} 📡 ZIVPN           $(mark zivpn)              ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}╚════════════════════════════════════════════════════════════════╝${K_RESET}"
echo

# ====== SECTION TOOLS ======
printf '%b\n' "${K_YELLOW}╔════════════════════════════════════════════════════════════════╗${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}                  ${K_WHITE}🛠️  TOOLS${K_RESET}                                   ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}╠════════════════════════════════════════════════════════════════╣${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[07]${K_RESET} 🌐 DNS PANEL                                       ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[08]${K_RESET} 🔗 DOMAIN PANEL                                    ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[09]${K_RESET} 🌍 IPV6 PANEL                                      ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[10]${K_RESET} 📊 VPS STATUS                                      ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[11]${K_RESET} 🛡️  NETGUARD PANEL                                  ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[12]${K_RESET} 🔌 VPN PORT INFO                                   ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[13]${K_RESET} 🧹 CLEAN VPS LOGS                                  ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[14]${K_RESET} 🤖 TOM_TUNNEL BOT PANEL                            ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[15]${K_RESET} 🗑️  UNINSTALL TOM_TUNNEL                            ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}║${K_RESET}  ${K_CYAN}[16]${K_RESET} ⚡ FAST DNS MENU                                    ${K_YELLOW}║${K_RESET}"
printf '%b\n' "${K_YELLOW}╚════════════════════════════════════════════════════════════════╝${K_RESET}"
echo

# ====== SECTION WEB PANEL ======
printf '%b\n' "${K_GREEN}╔════════════════════════════════════════════════════════════════╗${K_RESET}"
printf '%b\n' "${K_GREEN}║${K_RESET}                 ${K_WHITE}🌐 WEB PANEL${K_RESET}                                  ${K_GREEN}║${K_RESET}"
printf '%b\n' "${K_GREEN}╠════════════════════════════════════════════════════════════════╣${K_RESET}"
printf '%b\n' "${K_GREEN}║${K_RESET}  ${K_CYAN}[18]${K_RESET} 🖥️  TOM_TUNNEL WEB  $(mark tom_tunnel-web 2>/dev/null || echo -e "${K_DIM}—${K_RESET}")                ${K_GREEN}║${K_RESET}"
printf '%b\n' "${K_GREEN}╚════════════════════════════════════════════════════════════════╝${K_RESET}"
echo

# ====== SECTION SYSTEM ======
printf '%b\n' "${K_RED}╔════════════════════════════════════════════════════════════════╗${K_RESET}"
printf '%b\n' "${K_RED}║${K_RESET}                  ${K_WHITE}⚙️  SYSTEM${K_RESET}                                  ${K_RED}║${K_RESET}"
printf '%b\n' "${K_RED}╠════════════════════════════════════════════════════════════════╣${K_RESET}"
printf '%b\n' "${K_RED}║${K_RESET}  ${K_CYAN}[00]${K_RESET} 🚪 EXIT                                          ${K_RED}║${K_RESET}"
printf '%b\n' "${K_RED}║${K_RESET}  ${K_CYAN}[88]${K_RESET} 🔄 REBOOT VPS                                     ${K_RED}║${K_RESET}"
printf '%b\n' "${K_RED}║${K_RESET}  ${K_CYAN}[99]${K_RESET} 🔃 UPDATE TOM_TUNNEL                              ${K_RED}║${K_RESET}"
printf '%b\n' "${K_RED}╚════════════════════════════════════════════════════════════════╝${K_RESET}"
echo
